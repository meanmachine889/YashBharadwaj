  ...
  return (
    <div className="flex flex-col min-w-screen min-h-screen  max-w-screen justify-center items-center">
      {<div className="w-[100%] flex flex-col justify-center items-center">
        <div
          className="bg-grid-small-orange-500/[0.3] overflow-y-hidden w-[100%] curdor h-[94vh] mt-[3rem] items-center flex gap-9 pt-9 lg:px-9 px-2 md:flex-row flex-col-reverse"
        >
          {/* <Image
            quality={100}
            src={"p3 3.svg"}
          ...
          <div className="flex flex-col  md:text-[8vw] text-[20vw] font-extrabold md:items-center items-center justify-center flex-1">
            <div className="flex text-orange-500 lg:gap-5 gap-2 md:mt-0 justify-start items-center">
              <p>clarity</p>
            ...
            <div className="w-[45%] flex md:text-[1.5vw] text-[5vw] font-medium justify-center items-center px-[2vw] gap-[2vw] mt-9">
              <Link href={"https://clarity-beige.vercel.app"} className="rounded-[3rem] gap-3 flex items-center justify-center border-2 md:border-4 hover:gap-5 transition-all border-white md:px-7 md:py-4 p-3">
                visit
                <ArrowRight/>
              </Link>
              <Link href={"https://clarity-beige.vercel.app"} className="gap-3 rounded-[3rem] flex items-center justify-center border-2 md:border-4 hover:gap-5 transition-all border-white md:px-7 md:py-4 p-3">
                github
                <ArrowRight/>
              </Link>
            </div>
