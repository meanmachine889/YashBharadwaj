...
const Hm = (props: Props) => {
  return (
    <div className="w-[100%] min-h-[100vh] flex flex-col justify-start items-center">
      <div className="flex flex-col w-[100%] items-center justify-center">
      <div className="flex py-9 w-[100%] md:h-screen items-center justify-center bg-purple-200 pt-[6rem]">
          <div className=" flex justify-center items-center shadow-xl rounded-xl">
            <Image
              ...
              quality={100}
              width={800}
              className="md:min-w-[75vw] md:rounded-xl rounded-md max-w-[90vw]"
              height={120}
            />
          </div>
        </div>
